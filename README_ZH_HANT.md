...
[English](README.md) | [简体中文](README_ZH.md) | [Español](README_ES.md) | [Français](README_FR.md) | [日本語](README_JA.md) | [한국어](README_KO.md)
...
- 支援英文、簡體中文、繁體中文、西班牙文、法文、日文與韓文即時切換，並記住上次選擇的語言。
